		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demorouting title",
									"targetURL": "#demoroutingiddemorouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoroutingiddemorouting-display": {
								"semanticObject": "demoroutingiddemorouting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoroutingid.demorouting",
									"url": sap.ui.require.toUrl("demoroutingid/demorouting")
								}
							}
						}
					}
